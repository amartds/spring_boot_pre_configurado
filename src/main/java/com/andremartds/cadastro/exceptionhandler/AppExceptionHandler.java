package com.andremartds.cadastro.exceptionhandler;
...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadableResponseEntity(HttpMessageNotReadableException ex, 
		  HttpHeaders headers, HttpStatus status, WebRequest request) {
	  final String msgDev = ex.toString();
	  final String msgUser = this.messageSource.getMessage("mensagem.invalida",null, LocaleContextHolder.getLocale());
	  List<Error> msgs = Arrays.asList(new Error(msgDev, msgUser));
	  return handleExceptionInternal(ex, msgs, new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
  }
